...
export const EN: AppStrings = {
  ...
  ops: {
    ...
    anomalyHeading: 'Anomalies',
    anomalyEmpty: 'No anomalies recorded.',
    anomalyNote:
      'Each row flags possible use of the account against someone else — an upload about a different person than the verified account holder, for instance. Review them by hand; nothing here is decided by the system.',
    anomalyReviewed: 'Reviewed',
    anomalyOpen: 'Open',
    inboxEmpty: 'Nothing in the inbox.',
    inboxUnassigned: 'Not yet matched to a case',
    inboxAssigned: 'Matched',
    controllerLabel: 'Company',
    venueLabel: 'Supervisory authority',
    venueUserResidence: "The authority for the data subject's own state (still to be determined)",
    reasonLabel: 'Reason',
  ...
  stateLabel: {
    ...
    READY: 'Ready to send',
    SENT: 'Sent',
    AWAITING_DELIVERY_PROOF: 'Letter posted — awaiting the delivery receipt',
